  ...
  const works = [
    {
      ...
      description: "... backend developed with SpringBoot, Spring Security and Spring Data with JPA and dependencies management with Maven Lifecycle. Hexagonal arquitecture and clean code, 100% testable, scalable and maintainable",
      description2: "...frontend developed with React, using Google SSO and Stripe for the payment",
      description3: "... devops mplemented CI/CD pipeline using GitHub Actions, with build (push, pull request) and release workflows. Kubernetes with Docker containers to manage deployment in my own server",
