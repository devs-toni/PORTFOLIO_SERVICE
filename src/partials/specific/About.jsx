    ...
    <div className='flex flex-col justify-center'>
      <div className='flex flex-col lg:flex-row mb-12 mt-2'>
        ...
        <div className='flex flex-col justify-center w-full'>
          <p className='text-xs w-full mobile:text-sm mobile:leading-6 surface:text-xs sm:text-lg lg:text-left sm:w-full lg:text-sm xl:w-full xxl:text-xl xxl:w-full superxl:leading-8 mb-5'>{text.about.description1}</p>
          <p className='text-xs w-full mobile:text-sm mobile:leading-6 surface:text-xs sm:text-lg lg:text-left sm:w-full lg:text-sm xl:w-full xxl:text-xl xxl:w-full superxl:leading-8'>{text.about.description2}</p>
        </div>
      </div>
