...
function Skills() {
  ...
  return (
    <>
      <section className="flex flex-col pb-10 pt-10 xl:pb-20 xl:pt-20 justify-center z-30 superxl:justify-between bg-gray-300 min-h-screen"> 
        <div className="mx-auto w-full text-center md:mb-6 lg:text-right lg:max-w-3xl xl:mb-20 xl:max-w-5xl xl:pr-10">
