...
function Skills() {
  ...
  return (
    <>
      <section className="bg-white flex flex-col pb-10 lg:pt-10 lg:pb-16 justify-center z-30 superxl:justify-between">
        <div className="mx-auto w-full text-center mobile:pt-6 md:mb-6 lg:text-right lg:max-w-3xl xl:mb-8">
          <h2 className="text-2xl w-full mobile:text-4xl sm:text-6xl font-normal italic mb-4 md:mb-0 xl:text-8xl text-gray-700">{text.skills.title}</h2>
        </div>
